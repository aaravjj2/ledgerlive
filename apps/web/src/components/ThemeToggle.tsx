...
function ThemeToggle({ className = '', dataTestId }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      onClick={cycle}
      className={`px-3 py-1.5 rounded-lg text-sm font-medium border border-gray-300 dark:border-gray-600 hover:bg-[#1A1A24] dark:hover:bg-gray-700 transition ${className}`}
