...
export default function ForecastingPage() {
  ...
  return (
    <div data-testid="forecasting-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="forecasting-title">Forecasting</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Forecasting via API /api/forecasting</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
