...
export default function BudgetingPage() {
  ...
  return (
    <div data-testid="budgeting-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="budgeting-title">Budgeting</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Budgeting via API /api/budgeting</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
