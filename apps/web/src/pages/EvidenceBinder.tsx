...
export default function EvidenceBinderPage() {
  ...
  return (
    <div data-testid="evidence-binder-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="evidence-binder-title">Evidence Binder</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Evidence Binder via API /api/evidence-binder</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
