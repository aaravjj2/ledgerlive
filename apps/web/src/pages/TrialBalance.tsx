...
export default function TrialBalancePage() {
  ...
  return (
    <div data-testid="trial-balance-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="trial-balance-title">Trial Balance</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Trial Balance via API /api/trial-balance</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
