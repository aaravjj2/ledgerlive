...
export default function LapTimeTelemetryPage() {
  ...
  return (
    <div data-testid="lap-time-telemetry-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="lap-time-telemetry-title">Lap Time Telemetry</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Lap Time Telemetry via API /api/lap-time-telemetry</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
