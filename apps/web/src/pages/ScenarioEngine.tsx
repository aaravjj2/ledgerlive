...
export default function ScenarioEnginePage() {
  ...
  return (
    <div data-testid="scenario-engine-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="scenario-engine-title">Scenario Engine</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Scenario Engine via API /api/scenarios</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
