...
interface PitStopOptimizerItem {
  id: string
  name?: string
  status?: string
  created_at?: string
...
export default function PitStopOptimizerPage() {
  ...
  return (
    <div data-testid="pit-stop-optimizer-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="pit-stop-optimizer-title">Pit Stop Optimizer</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Pit Stop Optimizer via API /api/pit-stop-optimizer</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
