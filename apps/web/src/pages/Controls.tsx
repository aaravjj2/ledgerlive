...
export default function ControlsPage() {
  ...
  return (
    <div data-testid="controls-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="controls-title">Controls Catalog</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Controls Catalog via API /api/controls</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
