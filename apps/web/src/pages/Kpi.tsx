...
export default function KpiPage() {
  ...
  return (
    <div data-testid="kpi-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="kpi-title">KPI Framework</h1>
          <p className="text-gray-500 text-sm mt-1">Manage KPI Framework via API /api/kpi</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
