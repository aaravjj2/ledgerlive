...
export default function ReadinessDashboardPage() {
  ...
  return (
    <div data-testid="readiness-dashboard-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="readiness-dashboard-title">Readiness Dashboard</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Readiness Dashboard via API /api/readiness-dashboard</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
