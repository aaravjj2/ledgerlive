...
export default function TraceExplorerPage() {
  ...
  return (
    <div data-testid="trace-explorer-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="trace-explorer-title">Trace Explorer</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Trace Explorer via API /api/trace</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
