...
export default function FinancialStatementsPage() {
  ...
  return (
    <div data-testid="financial-statements-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="financial-statements-title">Financial Statements</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Financial Statements via API /api/statements</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
