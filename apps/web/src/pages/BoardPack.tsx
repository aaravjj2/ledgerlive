...
export default function BoardPackPage() {
  ...
  return (
    <div data-testid="board-pack-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="board-pack-title">Board Pack</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Board Pack via API /api/board-pack</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
