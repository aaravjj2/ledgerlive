...
export default function Soc2Page() {
  ...
  return (
    <div data-testid="soc2-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="soc2-title">SOC2 Evidence</h1>
          <p className="text-gray-500 text-sm mt-1">Manage SOC2 Evidence via API /api/soc2</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
