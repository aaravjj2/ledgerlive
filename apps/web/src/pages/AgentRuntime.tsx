...
export default function AgentRuntimePage() {
  ...
  return (
    <div data-testid="agent-runtime-page" className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold" data-testid="agent-runtime-title">Agent Runtime</h1>
          <p className="text-gray-500 text-sm mt-1">Manage Agent Runtime via API /api/agent-runtime</p>
        </div>
        <button
          onClick={load}
          disabled={loading}
